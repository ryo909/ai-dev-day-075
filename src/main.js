import './style.css';
const PROFILE = {"day":"Day075","title":"Event Role Badge Mixer","display_name_ja":"係バッジ混ぜ","one_sentence":"集まりの係を、ちょっと笑えるバッジにして割り当てるツール","purpose_line_ja":"集まりの軽い係をバッジで配るツールです。","use_case_line_ja":"イベント直前に係をゆるく決める時に使います。","how_it_works_line_ja":"人と係を入れると、バッジが配られます。","core_action":"fun_card_mix","family":"role_badge_fun_play","mechanic":"fun_card_mix","input_style":"people_chips","output_style":"certificate_card","output_label":"ここを見ればOKです","audience_promise":"堅くならずに役割をその場で渡せる。","publish_hook":"人と係を入れると、負担が偏りすぎないバッジが遊び感のあるカードで配れる。","engine":"brief_driven","interaction_archetype":"fun_card_mix","page_archetype":"card_stack","ui_variant":"certificate","intro_variant":"tiny_win_certificate","interaction_model":"editable_win_to_certificate","primary_layout":"win_editor_with_certificate_preview","result_presentation_style":"share_ready_certificate_card","palette_motif":"小さな勝ちゴールド","main_cta":"今日の小さな勝ちで試す","input_panel_title":"できたことと賞名を入れる","sample_panel_title":"小さな達成で試す","guide_panel_title":"賞状の見どころ","hero_panel_label":"今日の賞状","output_shape":"card_stack","state_model":"fun_card_mix_state","core_loop":"people_chips -> fun_card_mix -> certificate_card","component_pack":"card_stack+certificate_card","scaffold_id":"brief_canvas","single_shot_text_generator":false};
